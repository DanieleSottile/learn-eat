...
try {
    ...
    ORM::configure('mysql:host=localhost;dbname=learneat');
...
//$app->add(new LearnEat\Middleware\Cache('/api/v1'));

// Parses JSON body
$app->add(new \Slim\Middleware\ContentTypes());

// Manage Rate Limit
//$app->add(new LearnEat\Middleware\RateLimit('/api/v1'));

// JSON Middleware
$app->add(new LearnEat\Middleware\JSON('/api/v1'));

// Auth Middleware (outer)
$app->add(new LearnEat\Middleware\TokenOverBasicAuth(array('root' => '/api/v1')));